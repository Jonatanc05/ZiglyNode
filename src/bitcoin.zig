...
pub const Block = struct {
    ...
    pub fn parse(data: []const u8) Block {
        ...
        for (0..32) |i| block.merkle_root[31 - i] = cursor.readInt(u8, .little);
        block.timestamp = cursor.readInt(u32, .little);
        block.bits = cursor.readInt(u32, .little);
...
test "block: calculate new bits" {
    ...
    }
    {
        ...
        // Block 2015
        const last = Block.parse(&[_]u8{0x01, 0x00, 0x00, 0x00, 0xe2, 0x55, 0x09, 0xcd, 0xe7, 0x07, 0xc3, 0xd0, 0x2a, 0x69, 0x3e, 0x4f, 0xe9, 0xe7, 0xcd, 0xd5, 0x7c, 0x38, 0xa0, 0xd2, 0xc8, 0xd6, 0x34, 0x1f, 0x20, 0xda, 0xe8, 0x4b, 0x00, 0x00, 0x00, 0x00, 0x0c, 0x11, 0x3d, 0xf1, 0x18, 0x5e, 0x16, 0x2e, 0xe9, 0x2d, 0x03, 0x1f, 0xe2, 0x1d, 0x14, 0x00, 0xff, 0x7d, 0x70, 0x5a, 0x3e, 0x9b, 0x9c, 0x86, 0x0e, 0xea, 0x85, 0x53, 0x13, 0xcd, 0x8c, 0xa2, 0x6c, 0x08, 0x7f, 0x49, 0xff, 0xff, 0x00, 0x1d, 0x30, 0xb7, 0x32, 0x31});
